			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Report <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="att/report">Attendance Report</a></li>
									</ul>
								</li>
                    ...
                    <li><a href="/level">Level Setting</a></li>
								...
								<li><a><i class="fa fa-clone"></i>Utility <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="/useradmin">User Administrator</a></li>
									</ul>
								</li>
							</ul>
            </div>
